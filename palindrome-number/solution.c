...
static const uint64_t base_6 = 10 * ((uint64_t)(1) << 48) / 1000000 + 1;
static const uint64_t base_7 = 10 * ((uint64_t)(1) << 48) / 10000000 + 1;
static const uint64_t base_8 = 10 * ((uint64_t)(1) << 57) / 100000000 + 1;
...
bool isPalindrome(int x) {
  ...
  if (x < 1000000) {
    ...
    uint64_t d0 = (base_6 * x) >> 16;
    uint64_t d1 = (d0 & mask_32) * 10;
    uint64_t d2 = (d1 & mask_32) * 10;
    uint64_t d3 = (d2 & mask_32) * 10;
    uint64_t d4 = (d3 & mask_32) * 10;
    uint64_t d5 = (d4 & mask_32) * 10;
    return (d0 >> 32) == (d5 >> 32) && (d1 >> 32) == (d4 >> 32) &&
           (d2 >> 32) == (d3 >> 32);
  }
  ...
  if (x < 100000000) {
    ...
    return (d0 >> 57) == (d7 >> 57) && (d1 >> 57) == (d6 >> 57) &&
  ...
  return dd == (d8 >> 57) && (d0 >> 57) == (d7 >> 57) &&
         (d1 >> 57) == (d6 >> 57) && (d2 >> 57) == (d5 >> 57) &&
         (d3 >> 57) == (d4 >> 57);
}